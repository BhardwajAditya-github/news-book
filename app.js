...
var headings = ['PayPal enables transfer of digital currencies to external wallets',"Prime Minister Giorgia Meloni's new bill also includes an incentive for those declaring crypto for tax purposes.","Microstrategy Buys More Bitcoin — Company's Crypto Holdings Grow to 132,500 BTC","'Bitcoin Miners' Revenue Hits $9.55 Billion in 2022","Mango Markets Exploiter Eisenberg Arrested in Puerto Rico"]
var newsContent = [`The move comes after nearly two years since PayPal enabled users to buy and sell crypto on its platform.
...
The company is also working to integrate other forms of cryptocurrency services, such as central bank digital currencies, to boost its digital footprint. It is also exploring the possibility of launching its own stablecoin, dubbed "PayPal Coin." The discovery came after a developer found evidence of such a stablecoin within the source code of the company's iPhone app.`,`Prime Minister Giorgia Meloni's new bill also includes an incentive for those declaring crypto for tax purposes. Crypto traders in Italy will be subject to a 26% capital-gains tax starting in 2023, according to a new budget that won parliamentary approval on Thursday.
...
`,`Microstrategy is now holding approximately 132,500 bitcoin following its most recent purchases. This year, the world’s largest cryptocurrency has emerged as “the institutional-grade digital asset,” said Microstrategy founder Michael Saylor. Microstrategy Acquires More Bitcoin
...
In its filing with the U.S. Securities and Exchange Commission (SEC), Microstrategy clarified that the 2,500 
...
app.get("/",function(request,response){
    ...
    response.render("home",{titles:headings})
})

app.get("/news",function(request,response){
    const no = request.query.n;
    response.render("news",{newsData:newsData,n:no})
})
